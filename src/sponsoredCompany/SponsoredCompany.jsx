  ...
  return (
    <div className='card border-0 px-0 mb-4 mt-5'>
        ...
        <div className="card-body px-0">
            ...
            <Rating className='text-center mb-3' initialValue={props.rating} readonly={readonly} size={size}/>
            </div>
        </div>
        <div className="card-footer px-0 bg-white pt-0 wrapper">
        <ul className="list-group list-group-flush mb-3">
            ...
            <a href={props.websiteUrl} target="_blank" className="d-block btn btn-primary mx-3" rel='nofollow'>visiter le site</a>
